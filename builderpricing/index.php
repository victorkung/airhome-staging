...
<head>
  ...
  <title>Airhome Partner Pricing & System Configurations</title>
  <meta name="description" content="Use the Airhome system configurator to create a custom systems for your new homes or remodeled homes.">
...
padding-left: 15px;"><img src="https://airhome.io/builderpricing/PricingCalc/airhome-partner-program.jpg" style="width: 80%;"><span class="pdfHeaderPara" style="font-size: 12px;
    ...
    padding-top: 25px;
    display: block;
    color: #555;">Private and Confidential. This builder price summary of your Airhome configuration is available to Airhome Partner Program members only. Please contact sales if you would like to purchase this system. Email: <a href="mailto:sales@airhome.io">sales@airhome.io</a> or call us at +1 (780) 809-1089.<br><br>To modify this configuration, click <a id="pdfChange" href="">here</a>.</div>
...
<a href="#" class="emailCopy">Share or Download this configuration <i class="fa fa-envelope emailButton"></i></a>
</div>
