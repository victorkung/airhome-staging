...
function checkZip(entry) {
    ...
    if (fullTrimmed.length > 5) {
        ...
        if ((fullTrimmed >=32004 && fullTrimmed <= 34997) || (fullTrimmed == 73301) || (fullTrimmed >= 75001 && fullTrimmed <= 75501) || (fullTrimmed >= 75503 && fullTrimmed <= 79999) || (fullTrimmed >= 88510 && fullTrimmed <= 88589) || (fullTrimmed >= 85001 && fullTrimmed <= 86556)) {
                $(".zipcodeSlide").slideDown(500);
                $(".currencySelect").val("USD");
                setTimeout(function(){
                        $(".calculatorPrice").text(calculatorADD()).digits();
