...
<head>
  ...
  <?php include 'sheetPriceImport.php'; ?>
  <script>
  
  
var livePanelUSD = '<?php echo $livepanelUSD; ?>';
var livePanelCAD = '<?php echo $livepanelCAN; ?>';
var livePanelName = '<?php echo $livepanelName; ?>';
var liveStereoUSD = '<?php echo $livestereoUSD; ?>';
var liveStereoCAD = '<?php echo $livestereoCAN; ?>';
var liveStereoName = '<?php echo $livestereoName; ?>';
var liveSurroundUSD = '<?php echo $livesurroundUSD; ?>';
var liveSurroundCAD = '<?php echo $livesurroundCAN; ?>';
var liveSurroundName = '<?php echo $livesurroundName; ?>';
var livePlateUSD = '<?php echo $liveplateUSD; ?>';
var livePlateCAD = '<?php echo $liveplateCAN; ?>';
var livePlateName = '<?php echo $liveplateName; ?>';
var liveSpeakerUSD = '<?php echo $livespeakerUSD; ?>';
var liveSpeakerCAD = '<?php echo $livespeakerCAN; ?>';
var liveSpeakerName = '<?php echo $livespeakerName; ?>';
var liveSubUSD = '<?php echo $livesubUSD; ?>';
var liveSubCAD = '<?php echo $livesubCAN; ?>';
var liveSubName = '<?php echo $livesubName; ?>';
var liveAppleUSD = '<?php echo $liveappletvUSD; ?>';
var liveAppleCAD = '<?php echo $liveappletvCAN; ?>';
var liveAppleName = '<?php echo $liveappletvName; ?>';
var liveCommIUSD = '<?php echo $livecommIUSD; ?>';
var liveCommICAD = '<?php echo $livecommICAN; ?>';
var liveCommIName = '<?php echo $livecommIName; ?>';
var liveCommIIUSD = '<?php echo $livecommIIUSD; ?>';
var liveCommIICAD = '<?php echo $livecommIICAN; ?>';
var liveCommIIName = '<?php echo $livecommIIName; ?>';
var liveCommIIIUSD = '<?php echo $livecommIIIUSD; ?>';
var liveCommIIICAD = '<?php echo $livecommIIICAN; ?>';
var liveCommIIIName = '<?php echo $livecommIIIName; ?>';
var liveCommIVUSD = '<?php echo $livecommIVUSD; ?>';
var liveCommIVCAD = '<?php echo $livecommIVCAN; ?>';
var liveCommIVName = '<?php echo $livecommIVName; ?>';
var liveCommVUSD = '<?php echo $livecommVUSD; ?>';
var liveCommVCAD = '<?php echo $livecommVCAN; ?>';
var liveCommVName = '<?php echo $livecommVName; ?>';
var liveCommVIUSD = '<?php echo $livecommVIUSD; ?>';
var liveCommVICAD = '<?php echo $livecommVICAN; ?>';
var liveCommVIName = '<?php echo $livecommVIName; ?>';
...
<div id="emailWindow">
    ...
    <span class="popUpTitle">Share or Download this configuration<i class="fa fa-times"></i></span><form id="configuratorSend"><p id="returnmessage"></p>
        ...
        <div id="subscribeEmail" class="checkboxOuter"><span class="checkboxInner">No </span><label class="checkboxLabel"><input type="checkbox" name="newsletterCheck" class="newsletterCheck"><span class="checkboxSpan"></span></label><span class="checkboxInner"> Yes</span><img src="./loader.gif" class="loaderImage"</a></div>
              ...
              <input type="text" id="sharingURL" class="regularText" readonly>
